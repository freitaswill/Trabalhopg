...
{
	if (transform[a].x * 800 + size[a][0] / 2 <= transform[b].x * 800 - size[b][0] / 2 ||
		transform[a].x * 800 - size[a][0] / 2 >= transform[b].x * 800 + size[b][0] / 2 ||
		transform[a].y * 800 + size[a][0] / 2 <= transform[b].y * 800 - size[b][0] / 2 ||
		transform[a].y * 800 - size[a][0] / 2 >= transform[b].y * 800 + size[b][0] / 2) {
		return true;
	}
	else
